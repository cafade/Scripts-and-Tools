...
############################################################################# 
# 
# With minor modifications to allow sending emails through Gmail
#
...
HOSTNAME="smtp.gmail.com"            # (Opt) Set envvar for 'helo'
smtpsrv="smtp.gmail.com"         # (Req) SMTP Server
mailfrom="<EMAIL_ADDRESS>"          # (Req) From Address
#mailto=""    # (Arg) To Address
#subject=""            # (Arg) Subject
...
################################################## 
smtpusr="$( echo -ne <EMAIL_ADDRESS> | base64 )" 
smtppwd="$( echo -ne <EMAIL_APP_PASSWORD> | base64 )" 
